...
function Portfolio(){
  ...
  return(
    ...
    <div className="row justify-content-center">
      <h3 class="pink-text text-center large-text col-12">Portfolio</h3>
      {projects.map ( project => (
         <div className={`${project.cssClass} col-5 mt-3  d-flex justify-content-center align-items-center `}>
         <div className="hide row">
         <a href={project.deployedAt} target='_blank' className="port-a">{project.name}</a>
         <a href={project.githubRepo} target='_blank' className="port-a">GitHub</a>
         </div>
       </div>
      ))}
